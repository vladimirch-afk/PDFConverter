...
class NewImageActivity : AppCompatActivity() {
    ...
    private var imagesName : String = System.currentTimeMillis().toString()
    private var image : MyImage = MyImage(imagesName, mutableListOf())
        ...
        imageCapture!!.takePicture(outputFileOptions, ContextCompat.getMainExecutor(this),
            object : ImageCapture.OnImageSavedCallback {
                override fun onImageSaved(outputFileResults: OutputFileResults) {
                    ...
                    image.images.add(photoFile.absolutePath)
                }
